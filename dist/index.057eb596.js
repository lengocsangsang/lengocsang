...
})({"9q5AP":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "c61d5d24057eb596";
"use strict";
...
},{}],"7fMQU":[function(require,module,exports,__globalThis) {
...
var _configJsVDateNow = require("./config.js?v=Date.now()");
function checkBirthday() {
    let today = new Date();
    let todayMonth = today.getMonth();
    let todayDate = today.getDate();
    // Check for birthdays today
    for(let name in 0, _configJsVDateNow.birthdays){
        let birthday = new Date((0, _configJsVDateNow.birthdays)[name]);
        ...
        if (todayMonth === birthdayMonth && todayDate === birthdayDate) {
            ...
            function assignFireworkEffects() {
                ...
                for(let i = 0; i < fireworks.length; i++){
                    const randomIndex = Math.floor(Math.random() * (0, _configJsVDateNow.fireworkColors).length);
                    const { color, shadow } = (0, _configJsVDateNow.fireworkColors)[randomIndex];
...
},{"./config.js?v=Date.now()":"bPnEg","@parcel/transformer-js/src/esmodule-helpers.js":"a75BS"}],"bPnEg":[function(require,module,exports,__globalThis) {
// Months for timeTitle.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "months", ()=>months);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"a75BS"}]},["9q5AP","7fMQU"], "7fMQU", "parcelRequire94c2")

//# sourceMappingURL=index.057eb596.js.map
